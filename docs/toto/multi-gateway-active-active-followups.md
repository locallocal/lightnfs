...
> 12 册（`docs/design/12-multi-gateway-active-active-steps.md`）的 A1–E3 已全部实现并合并
> （每步标 ✅ 2026-09-06）。本文件按 12 册 §E3 的约定，收口未闭环项，供后续处理；12 册在合并
> 后可撤下，记录留 git 历史。设计见 11 册，实现细化见 12 册。
