...
汇总 v1（= 开发计划阶段 5 末，另含阶段 6 第 1 项 v4.2 甜点）的测试证据：协议一致性
（cthon / pynfs / fsx）、三层基准数据与安全清单验收。逐阶段的完整记录见
[development-plan.md](development-plan.md) 各"完成记录"小节与 m1–m6 里程碑文档；本文只汇总
结论与数据，更新日期 2026-08-23。
