...
> 实现记录保留在 git 历史里**；当前的实现总览见 [09 册](../09-multi-gateway-failover.md) §9.10 代码地图，
> 设计动机见 [09 册](../09-multi-gateway-failover.md)，部署与运维见 [deployment.md §5 多网关主备](../../guide/deployment.md)。
>
...
| 想找 | 去哪 |
|------|------|
| 实现总览（代码地图） | [09 册](../09-multi-gateway-failover.md) §9.10 |
| 设计动机与协议语义 | [09 册](../09-multi-gateway-failover.md) |
| 部署拓扑、keepalived、运维 | [deployment.md §5](../../guide/deployment.md) |
| 配置键与指标 | [08 册](../08-config-observability.md) |
