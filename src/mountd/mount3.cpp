...
MountStatus map_error(Errno error) {
    switch (raw(error)) {
        case EPERM:
            return MountStatus::kPerm;
        case ENOENT:
        case ESTALE:
            return MountStatus::kNoent;
        case EACCES:
            return MountStatus::kAcces;
        case ENOTDIR:
            return MountStatus::kNotdir;
        case EINVAL:
            return MountStatus::kInval;
        case ENAMETOOLONG:
            return MountStatus::kNametoolong;
        case EOPNOTSUPP:
            return MountStatus::kNotsupp;
        default:
            return MountStatus::kIo;
    }
}
...
rt::Task<void> Mount3::dispatch(transport::ConnCtx& ctx, rpc::RpcCall& call, const rpc::Cred& rpc_cred) {
    ...
    // (followups/protocol-conformance-followups.md B8).
