...
class Listener {
 public:
    ...
    static Result<std::unique_ptr<Listener>> create(uint16_t port, TransportConfig cfg, rpc::Dispatcher& disp,
 ...
 private:
    Listener(std::vector<int> fds, uint16_t port, TransportConfig cfg, rpc::Dispatcher& disp, rt::Runtime& rt)
