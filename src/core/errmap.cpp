...
bool v3_error_allowed(P proc, S status) {
    ...
    switch (proc) {
        ...
        case P::kRead:
            return one_of(status, std::array{S::kNxio, S::kAcces, S::kIsdir, S::kInval, S::kJukebox});
        case P::kReaddir:
            return one_of(status, std::array{S::kAcces, S::kNotdir, S::kBadCookie, S::kToosmall});
        case P::kReaddirplus:
            return one_of(status, std::array{S::kAcces, S::kNotdir, S::kBadCookie, S::kToosmall, S::kNotsupp});
        case P::kFsstat:
        case P::kFsinfo:
        case P::kPathconf:
            return false;
...
bool v4_error_allowed(O4 op, S4 status) {
    ...
    switch (op) {
        case O4::kLookup:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kNametoolong, S4::kBadname, S4::kSymlink,
                                              S4::kWrongsec});
        case O4::kLookupp:
        ...
        case O4::kOpen:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kIsdir, S4::kSymlink, S4::kWrongType,
                                              ...
                                              S4::kBadname, S4::kShareDenied, S4::kGrace, S4::kNoGrace, S4::kReclaimBad,
                                              S4::kStaleClientid, S4::kInval, S4::kPerm});
        case O4::kClose:
        case O4::kOpenDowngrade:
            return one_of4(status,
                           std::array{S4::kBadStateid, S4::kStaleStateid, S4::kOldStateid, S4::kExpired, S4::kInval});
        case O4::kWrite:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kOpenmode, S4::kBadStateid,
                                              S4::kStaleStateid, S4::kOldStateid, S4::kGrace, S4::kExpired, S4::kRofs,
                                              S4::kFbig, S4::kNospc, S4::kDquot, S4::kLocked});
        case O4::kCommit:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kRofs});
        case O4::kSetattr:
            return one_of4(
                status, std::array{S4::kInval, S4::kIsdir, S4::kPerm, S4::kRofs, S4::kFbig, S4::kNospc, S4::kDquot,
                                   S4::kAttrnotsupp, S4::kBadowner, S4::kBadStateid, S4::kStaleStateid, S4::kOldStateid,
                                   S4::kOpenmode, S4::kGrace, S4::kExpired, S4::kLocked});
        case O4::kCreate:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kExist, S4::kRofs, S4::kNospc, S4::kDquot,
                                              S4::kNametoolong, S4::kBadname, S4::kBadtype, S4::kPerm, S4::kInval,
                                              S4::kMlink, S4::kAttrnotsupp, S4::kBadowner, S4::kNotsupp});
        case O4::kRemove:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kNotempty, S4::kRofs, S4::kNametoolong,
                                              S4::kBadname, S4::kInval, S4::kPerm, S4::kFileOpen});
        case O4::kRename:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kIsdir, S4::kExist, S4::kNotempty, S4::kXdev,
                                              S4::kRofs, S4::kNametoolong, S4::kBadname, S4::kInval, S4::kPerm,
                                              S4::kNospc, S4::kDquot, S4::kMlink, S4::kFileOpen, S4::kRestorefh});
        case O4::kLink:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kIsdir, S4::kExist, S4::kXdev, S4::kRofs,
                                              S4::kNametoolong, S4::kBadname, S4::kInval, S4::kPerm, S4::kNospc,
                                              S4::kDquot, S4::kMlink, S4::kNotsupp, S4::kWrongType, S4::kRestorefh});
        case O4::kLock:
        case O4::kLockt:
        case O4::kLocku:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kDenied, S4::kBadStateid,
                                              S4::kStaleStateid, S4::kOldStateid, S4::kOpenmode, S4::kGrace,
                                              S4::kNoGrace, S4::kReclaimBad, S4::kExpired, S4::kStaleClientid,
                                              S4::kBadRange, S4::kLockRange, S4::kLockNotsupp});
        case O4::kSecinfo:
            return one_of4(
                status, std::array{S4::kNoent, S4::kNotdir, S4::kNametoolong, S4::kBadname, S4::kInval, S4::kWrongsec});
        case O4::kSecinfoNoName:
            return one_of4(status, std::array{S4::kNoent, S4::kNotdir, S4::kInval, S4::kWrongsec});
        case O4::kFreeStateid:
            return one_of4(status, std::array{S4::kBadStateid, S4::kStaleStateid, S4::kLocksHeld});
        case O4::kTestStateid:
            return false;
        case O4::kReclaimComplete:
            return one_of4(status, std::array{S4::kCompleteAlready, S4::kStaleClientid});
        // NFSv4.2 rows (RFC 7862 §11.2).
        case O4::kSeek:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kSymlink, S4::kNxio,
                                              S4::kNotsupp, S4::kUnionNotsupp, S4::kBadStateid, S4::kStaleStateid,
                                              S4::kOldStateid, S4::kOpenmode, S4::kGrace, S4::kExpired});
        case O4::kAllocate:
        case O4::kDeallocate:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kSymlink, S4::kNotsupp,
                                              S4::kBadStateid, S4::kStaleStateid, S4::kOldStateid, S4::kOpenmode,
                                              S4::kGrace, S4::kExpired, S4::kRofs, S4::kFbig, S4::kNospc, S4::kDquot});
        case O4::kClone:
            return one_of4(
                status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kSymlink, S4::kNotsupp, S4::kBadStateid,
                                   S4::kStaleStateid, S4::kOldStateid, S4::kOpenmode, S4::kGrace, S4::kExpired,
                                   S4::kRofs, S4::kFbig, S4::kNospc, S4::kDquot, S4::kXdev, S4::kLocked});
        case O4::kCopy:
            return one_of4(status, std::array{S4::kInval, S4::kIsdir, S4::kWrongType, S4::kSymlink, S4::kNotsupp,
                                              S4::kBadStateid, S4::kStaleStateid, S4::kOldStateid, S4::kOpenmode,
                                              S4::kGrace, S4::kExpired, S4::kRofs, S4::kFbig, S4::kNospc, S4::kDquot,
