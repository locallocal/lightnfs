...
struct Api {
    ...
    int (*glfs_set_volfile_server)(glfs*, const char* transport, const char* host, int port) = nullptr;
    ...
    glfs_object* (*glfs_h_lookupat)(glfs*, glfs_object* parent, const char* path, struct stat*, int follow) = nullptr;
    glfs_object* (*glfs_h_creat)(glfs*, glfs_object* parent, const char* path, int flags, mode_t,
                                 struct stat*) = nullptr;
    glfs_object* (*glfs_h_mkdir)(glfs*, glfs_object* parent, const char* path, mode_t, struct stat*) = nullptr;
    glfs_object* (*glfs_h_mknod)(glfs*, glfs_object* parent, const char* path, mode_t, dev_t, struct stat*) = nullptr;
    glfs_object* (*glfs_h_symlink)(glfs*, glfs_object* parent, const char* name, const char* data,
                                   struct stat*) = nullptr;
    ...
    int (*glfs_h_link)(glfs*, glfs_object* linktgt, glfs_object* parent, const char* name) = nullptr;
    int (*glfs_h_rename)(glfs*, glfs_object* olddir, const char* oldname, glfs_object* newdir,
                         const char* newname) = nullptr;
    ssize_t (*glfs_h_extract_handle)(glfs_object*, unsigned char* handle, int len) = nullptr;
    glfs_object* (*glfs_h_create_from_handle)(glfs*, unsigned char* handle, int len, struct stat*) = nullptr;
    ...
    ssize_t (*glfs_pwrite)(glfs_fd*, const void* buf, size_t count, off_t offset, int flags, struct glfs_stat* prestat,
                           struct glfs_stat* poststat) = nullptr;
    ssize_t (*glfs_pwritev)(glfs_fd*, const struct iovec*, int iovcnt, off_t offset, int flags) = nullptr;
    ...
    ssize_t (*glfs_copy_file_range)(glfs_fd* in, off64_t* off_in, glfs_fd* out, off64_t* off_out, size_t len,
                                    unsigned int flags, struct glfs_stat* statbuf, struct glfs_stat* prestat,
                                    struct glfs_stat* poststat) = nullptr;
    // directories
    int (*glfs_xreaddirplus_r)(glfs_fd*, uint32_t flags, glfs_xreaddirp_stat** xstat_p, struct dirent* ext,
