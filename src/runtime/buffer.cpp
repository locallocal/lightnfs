...
static_assert(BufferPool::kClasses == 5 && sizeof(detail::Magazine::head) / sizeof(detail::Block*) == 5);
...
detail::Block* BufferPool::take_or_create(int cls, size_t cap) {
    ...
    return new detail::Block{mem, static_cast<uint32_t>(cap), {1}, cls >= 0 ? this : nullptr, nullptr};
}
