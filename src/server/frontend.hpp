...
struct Frontend {
    ...
    static std::optional<Frontend> start(const core::ServerConfig& cfg, rt::Runtime& runtime, ProtocolStack& stack,
    ...
    bool drain_connections(std::chrono::milliseconds grace, std::chrono::milliseconds close_timeout);
};
