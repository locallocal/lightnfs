...
class ClusterController {
 ...
 private:
    ...
    std::chrono::milliseconds ttl() const { return std::chrono::milliseconds(3 * cfg_.fence_lease_ms); }
...
class FsClusterController {
 public:
    ...
    FsClusterController(const core::ClusterConfig& cfg, const core::ExportTable& exports, ClusterStore& store,
                        core::FsOwnerView& view, Hooks hooks, uint64_t node_epoch = 0);
    ~FsClusterController();
